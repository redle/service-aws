...
SOURCES		= server/encrypt.cc server/aws_client.cc server/procotol.cc server/message.cc server/database.cc server/server.cc threads/thread.cc tcpsockets/tcpacceptor.cc tcpsockets/tcpstream.cc protobuf/kv.proto.pb.cc
